...
| ----------- | ----------- | ----------- | ----------- |
| Sound and Noise Sensor | Electret Microphone Amplifier - MAX9814 | Electret condenser microphones function by utilizing a diaphragm as a capacitor plate. Vibrations by the diaphragm generated by sound produce changes the distance between the diaphragm and the second plate. Thus, causing a difference in voltage, which is amplified and converted to reflect audio signal at the output. [^9], [^10] | <ul><li>Supply Voltage: 2.7v-5.5v @ 3mA current</li><li>Frequency Response: 20Hz - 20 KHz</li><li> Temperature Range: −55°C to +125°C</li></ul> [^9] |
| Accelerometer Sensor | ADXL335 - 5V ready triple axis accelerometer | This accelerometer measures capacitance changes based on the deflection of fixed plates and plates attached to a suspended structure. A proportional output voltage is generated for each axis when acceleration is detected.[^6] | <ul><li>Supply Voltage: 1.8v-3.6v @ 350 μA current</li><li>Frequency Response: 0.5Hz-1600Hz (X, Y-axes), 0.5Hz-550Hz (Z-axis)</li><li> Temperature Range: −55°C to +125°C</li></ul>[^11] |
| Temperature and Humidity | DHT11-temperature and humidity sensor | A DHT sensor is composed of a capacitive humidity sensor and a thermistor. The humidity is evaluated by using a small capacitor with a dielectric constant within 2-15. The relative humidity is what causes the dielectric material to change. The sensor evaluates moisture depending on its shift in the dielectric measurement, based upon several environmental variables. The sensor calculates ambient temperature by using the characteristics of semiconductors. As the temperature increases, the thermistor resistance value will increase incrementally, determining the temperature. [^12],[^13] | <ul><li>Supply Voltage: 3V to 5V @ 2.5 mA current</li><li>Frequency Response: 1 Hz maximum </li><li>Temperature Range: 0-50°C ±2°C Humidity Range: 20-80% ±5%</li></ul> [^14], [^15] |
...
[^12]: Rotronic. (n.d.). The capacitive humidity sensor. Rotronic Measurement Solutions. Retrieved October 13, 2021, from https://www.rotronic.com/media/productattachments/files/c/a/capacitive_humidity_sensor_final.pdf. 
[^13]: Omega Engineering. (2021, October 11). What is a thermistor and how does it work? https://www.omega.com/en-us/. Retrieved October 13, 2021, from https://www.omega.com/en-us/resources/thermistor. 
[^14]: Ada, L. (2012, July 29). DHT11, dht22 and AM2302 sensors. Adafruit Learning System. Retrieved October 13, 2021, from https://learn.adafruit.com/dht. 
[^15]: Roboshop.com. (2020). DHT11 Temperature Humidity Sensor Module. Roboshop.com. Retrieved 2021, from https://www.robotshop.com/media/catalog/product/cache/image/1350x/9df78eab33525d08d6e5fb8d27136e95/d/h/dht11-temperature-humidity-sensor-module.jpg. 
