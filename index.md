...
| Temperature and Humidity | Add description here | A DHT sensor is composed of a capacitive humidity sensor and a thermistor. The humidity is evaluated by using a small capacitor with a dielectric constant within 2-15. The relative humidity is what causes the dielectric material to change. The sensor evaluates moisture depending on its shift in the dielectric measurement, based upon several environmental variables. The sensor calculates ambient temperature by using the characteristics of semiconductors. As the temperature increases, the thermistor resistance value will increase incrementally, determining the temperature. | <ul><li>Supply Voltage: 3V to 5V @ 2.5 mA current</li><li>Frequency Response: 1 Hz maximum </li><li>Temperature Range: 0-50°C ±2°C Humidity Range: 20-80% ±5%</li></ul> |
